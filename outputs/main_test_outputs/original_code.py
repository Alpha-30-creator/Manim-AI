...
class main(VoiceoverScene):
    def construct(self):
        ...
        matrix_label = Tex(r"A = \begin{pmatrix} 2 & 1 \\ 1 & 2 \end{pmatrix}", font_size=36)
        ...
        eigenvector_arrow.shift(UP*1.5)  # Position in RIGHT zone
        ...
        summary_points = VGroup(
            Tex(r"\bullet\ Eigenvalues are the scaling factors."),
            Tex(r"\bullet\ Eigenvectors retain their direction."),
            Tex(r"\bullet\ They are fundamental in linear algebra and applications."))
        ...
        with self.voiceover(text="In summary, eigenvalues tell us how much an eigenvector is stretched, and the eigenvectors themselves maintain their direction. These concepts are crucial in many applications across science and engineering.") as tracker:
            # Remove earlier elements using explicit fade out (ONE IN, ONE OUT principle)
            self.play(
