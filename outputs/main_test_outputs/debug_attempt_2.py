...
class MainScene(VoiceoverScene):
    def construct(self):
        ...
        # Using MathTex for proper math rendering and to avoid LaTeX compilation issues
        ...
        # Using MathTex for bullet points with proper LaTeX formatting.
        summary_points = VGroup(
            MathTex(r"\bullet\ \text{Eigenvalues are the scaling factors.}", font_size=36),
            MathTex(r"\bullet\ \text{Eigenvectors retain their direction.}", font_size=36),
            MathTex(r"\bullet\ \text{They are fundamental in linear algebra and applications.}", font_size=36)
        )
